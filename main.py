...
BOT_TOKEN = "7190050666:AAGec7JH8eiUjwWNxFgS1Lsx79MC4nQ4u_4"
PAYMENT_CHANNEL = "@streaamdb3" #add payment channel here including the '@' sign
OWNER_ID = 6924888856 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@streaamdb3"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
